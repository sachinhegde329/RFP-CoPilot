      ...
      <main className="flex-1">
        ...
        <section className="py-20 bg-muted/30">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <Card className="p-6"><CardContent className="p-0"><p className="text-muted-foreground mb-4">"RFPs used to take us 3 days. Now it's 3 hours. This tool is a must-have for any serious sales team."</p><div className="flex items-center gap-3"><Image src="https://i.ibb.co/TMbzkqmG/Google-AI-Studio-2025-07-13-T11-25-43-726-Z.png" alt="User avatar" width={40} height={40} className="rounded-full" data-ai-hint="person avatar"/><p className="font-semibold">Ravi P., Head of Presales</p></div></CardContent></Card>
                    <Card className="p-6"><CardContent className="p-0"><p className="text-muted-foreground mb-4">"The ability to use our own templates is what sold us. We maintain our brand identity with the speed of AI."</p><div className="flex items-center gap-3"><Image src="https://i.ibb.co/TMbzkqmG/Google-AI-Studio-2025-07-13-T11-25-43-726-Z.png" alt="User avatar" width={40} height={40} className="rounded-full" data-ai-hint="person avatar"/><p className="font-semibold">Sarah L., Proposal Manager</p></div></CardContent></Card>
                    <Card className="p-6"><CardContent className="p-0"><p className="text-muted-foreground mb-4">"As a solo consultant, this tool lets me compete with big firms. It's like having an entire proposal team in my pocket."</p><div className="flex items-center gap-3"><Image src="https://i.ibb.co/TMbzkqmG/Google-AI-Studio-2025-07-13-T11-25-43-726-Z.png" alt="User avatar" width={40} height={40} className="rounded-full" data-ai-hint="person avatar"/><p className="font-semibold">Mike T., Independent Consultant</p></div></CardContent></Card>
                 </div>
            </div>
        </section>
